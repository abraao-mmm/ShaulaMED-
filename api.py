...
from transcritor import transcrever_audio_bytes # Módulo de transcrição agora usado aqui
from rich.console import Console

# --- INICIALIZAÇÃO E CONFIGURAÇÃO DA API ---
app = FastAPI(title="ShaulaMed API", version="3.0 - Transcrição no Back-end")
...
async def endpoint_transcrever_audio(ficheiro_audio: UploadFile = File(...)):
    """Recebe um ficheiro de áudio, transcreve-o e retorna o texto."""
    try:
