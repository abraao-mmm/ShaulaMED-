...
def shaulamed_app():
    ...
    API_URL = "https://shaulamed-api-1x9x.onrender.com" # Exemplo, use a sua URL real
    ...
    # É importante chamar st.set_page_config aqui dentro para que seja executado após o login
    st.set_page_config(
