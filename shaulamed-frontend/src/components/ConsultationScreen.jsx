...
import StarButton from './StarButton'; // Importamos o nosso botão com efeito de estrelas
...
const ConsultationScreen = ({ userId, onFinish }) => {
    ...
    const cardContents = {
        Insights: (
            <div style={cardContentStyle}>
                {!transcriptionComplete ? (
                    <StarButton onClick={handleRecordClick} disabled={isLoading}>
                        {isLoading ? "Processando..." : (isRecording ? "Parar Gravação" : "Iniciar Gravação")}
                    </StarButton>
                ) : (
                    <textarea 
                        style={textAreaStyle} 
        ...
        Efficiency: (
            <div style={{ ...cardContentStyle, justifyContent: 'space-around', alignItems: 'flex-start' }}>
                <div>
